  ...
  return (
    <div className="bg-body-tertiary" id="portfolio">
      ...
      <div className="container text-center mb-4">
        <div className="btn-group btn-group-lg" role="group" aria-label="Responsive Buttons">
          <button type="button" className="btn btn-info mx-2" onClick={() => handleTypeSelection("current")}>
            Current Works
          </button>
          <button type="button" className="btn btn-secondary mx-2" onClick={() => handleTypeSelection("previous")}>
            Previous Works
          </button>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit}>
            {selectedType === "current" && (
              <div className="mb-4">
                ...
                />
                <div className="mt-4">
                  <label htmlFor="currentDescription" className="form-label">Description</label>
                  <textarea
                ...
                />
                <div className="mt-4">
                  <label htmlFor="currentVideoDescription" className="form-label">Description</label>
                  <textarea
                    className="form-control"
            ...
            {selectedType === "previous" && (
              <div className="mb-4">
                ...
                />
                <div className="mt-4">
                  <label htmlFor="previousDescription" className="form-label">Description</label>
                  <textarea
                    className="form-control"
                ...
                />
                <div className="mt-4">
                  <label htmlFor="previousVideoDescription" className="form-label">Description</label>
                  <textarea
                    className="form-control"
